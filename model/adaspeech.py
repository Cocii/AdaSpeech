...
# like libritts each speaker has a unique id
class AdaSpeech(nn.Module):
    ...
    def __init__(self, preprocess_config, model_config):
        ...
        self.spkr_dic = json.load(open(os.path.join(preprocess_config["path"]["preprocessed_path"], "speakers.json"), "r"))
    ...
    def forward(
        ...
        speakers = [self.spkr_dic[speaker] for speaker in speakers]
        speakers = np.array(speakers)
        # for speaker in speakers:
        #     print("===================================== speakers:{}|".format(speaker))
        # assert speakers == ids
        speakers = torch.from_numpy(speakers).to(self.device)
